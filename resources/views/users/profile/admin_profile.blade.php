...
@section('content')
    <div class="row">
        ...
        <div class="col-lg-4 col-xlg-3 col-md-5">
            <div class="card">
                <div class="card-body">
                    <center class="mt-4"> <img src="{{ (!empty($admin->image))? asset('storage/'.$admin->image) : Gravatar::src($admin->user->email) }}" alt="{{$admin->user->email}}" class="rounded-circle" width="150" />
                        <h4 class="card-title mt-2">{{ $admin->last_name.' '.$admin->first_name.' '.$admin->other_name }}</h4>
                        <h6 class="card-subtitle"><span class="badge badge-info font-14">Portal {{ ($admin->user->type=='lvl05')?'Super':'' }} Administrator</span></h6>
                ...
                <div class="card-body"> <small class="text-muted">Email address </small>
                    <h6><a >{{ $admin->user->email }}</a></h6>
                    <small class="text-muted pt-4 db">Phone</small>
                    <h6>{{ $admin->phone }}</h6>
                    <small class="text-muted pt-4 db">Address</small>
                    <h6>{{ $admin->address }}</h6>
                    <div class="map-box">
                        <iframe src="https://www.google.com/maps/embed?{{ $admin->address }}" width="100%" height="150" frameborder="0" style="border:0" allowfullscreen></iframe>
                            ...
                            <form class="form-horizontal" action="{{ route('admin.update', auth()->user()->admin->user_uuid) }}" method="POST" enctype="multipart/form-data">
                                @csrf @method('PUT')
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="last_name" class="form-control @error('last_name') is-invalid @enderror" id="last_name" value="{{ $admin->last_name }}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="first_name" class="form-control @error('first_name') is-invalid @enderror" id="first_name" value="{{ $admin->first_name }}">
                                            <span role="alert" class="invalid-feedback">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="other_name" class="form-control @error('other_name') is-invalid @enderror" id="other_name" value="{{ $admin->other_name }}">
                                            <span role="alert" class="invalid-feedback">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input disabled type="email" name="email" class="form-control @error('email') is-invalid @enderror" id="email" value="{{ $admin->user->email }}">
                                            <span role="alert" class="invalid-feedback">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="phone" class="form-control @error('phone') is-invalid @enderror" id="phone" value="{{ $admin->phone }}">
                                        <span role="alert" class="invalid-feedback">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input required value="{{$admin->dob }}" name="dob" type="text" class="form-control mdate @error('dob') is-invalid @enderror" id="dob">
                                            <span role="alert" class="invalid-feedback">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea name="address" class="form-control @error('address') is-invalid @enderror" id="address" rows="2">{{ $admin->address }}</textarea>
                                        </div>
                                        <span role="alert" class="invalid-feedback">
                                            <strong>{{$errors->first('address')}}</strong>
                                        </span>
